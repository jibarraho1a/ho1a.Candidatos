...
{
    public sealed class RequisicionByCompensacionSpecification : BaseSpecification<Requisicion>
    {
        public RequisicionByCompensacionSpecification(string userName)
            : base(
                a => a.ValidaRequisiciones.All(v => v.EstadoValidacion == EEstadoValidacion.Aprobada)
