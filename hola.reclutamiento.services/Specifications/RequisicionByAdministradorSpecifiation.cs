...
{
    public class RequisicionByAdministradorSpecifiation : BaseSpecification<Requisicion>
    {
        public RequisicionByAdministradorSpecifiation()
            : base(
                a =>
                    a.ValidaRequisiciones != null)
        {
