...
{
    public sealed class RequisicionByDirectorRHSpecifiation : BaseSpecification<Requisicion>
    {
        public RequisicionByDirectorRHSpecifiation(string userName, bool isDireccionRH)
            : base(
                a => isDireccionRH && a.ValidaRequisiciones.All(v => v.EstadoValidacion == EEstadoValidacion.Aprobada)
