export class Candidato {
  ...
  initFromObject(candidate: Candidate) {
    ...
    this.candidateForm = <CandidateForm>{
      ...
      detalleId: this.candidate.detalle !== null &&
      this.candidate.detalle.id ? this.candidate.detalle.id : null,
      ...
      detalleDireccionId: this.candidate.detalle !== null &&
      this.candidate.detalle.direccion !== null &&
      this.candidate.detalle.direccion.id ? this.candidate.detalle.direccion.id : null,
      detalleDireccionActive : this.candidate.detalle !== null &&
      candidate.detalle.direccion !== null &&
      this.candidate.detalle.direccion.active ? this.candidate.detalle.direccion.active : false,
      detalleDireccionCandidatoId: this.candidate.detalle !== null &&
      this.candidate.detalle.direccion !== null ? this.candidate.detalle.direccion.candidatoId : null,
      detalleDireccionCalle: this.candidate.detalle &&
      this.candidate.detalle.direccion ? this.candidate.detalle.direccion.calle : null,
      detalleDireccionCodigoPostal: this.candidate.detalle &&
      this.candidate.detalle.direccion ? this.candidate.detalle.direccion.codigoPostal : null,
      detalleDireccionColonia: this.candidate.detalle &&
      this.candidate.detalle.direccion ? this.candidate.detalle.direccion.colonia : null,
      detalleDireccionEstado: this.candidate.detalle &&
      this.candidate.detalle.direccion ? this.candidate.detalle.direccion.estado : null,
      detalleDireccionMunicipio: this.candidate.detalle &&
      this.candidate.detalle.direccion ? this.candidate.detalle.direccion.municipio : null,
      detalleUltimoTrabajoId: this.candidate.detalle !== null &&
      this.candidate.detalle.ultimoTrabajo !== null &&
      this.candidate.detalle.ultimoTrabajo.id ? this.candidate.detalle.ultimoTrabajo.id : null,
      detalleUltimoTrabajoActive: this.candidate.detalle !== null &&
      this.candidate.detalle.ultimoTrabajo !== null &&
      this.candidate.detalle.ultimoTrabajo.active ? this.candidate.detalle.ultimoTrabajo.active : false,
      detalleUltimoTrabajoCandidatoId: this.candidate.detalle !== null &&
      this.candidate.detalle.ultimoTrabajo !== null ? this.candidate.detalle.ultimoTrabajo.candidatoId : null,
      detalleUltimoTrabajoIngresos: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.ingresos : null,
      detalleUltimoTrabajoPrestaciones: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.prestaciones : null,
      detalleUltimoTrabajoEmpresa: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.empresa : null,
      detalleUltimoTrabajoGastosMedicosMayores: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.gastosMedicosMayores : null,
      detalleUltimoTrabajoPuesto: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.puesto : null,
      detalleUltimoTrabajoSeguroVida: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.seguroVida : null,
      detalleUltimoTrabajoSueldoFijoMensual: this.candidate.detalle &&
      this.candidate.detalle.ultimoTrabajo ? this.candidate.detalle.ultimoTrabajo.sueldoFijoMensual : null,
